...
CImageFind.prototype.GetFlickrImage=function(callback)							// GET FLICKR IMAGE
{
		...
		str+="<div id='picGal' style='display:inline-block;border-radius: 0 8px 8px 0;width:666px;height:290px;overflow-y:auto;background-color:#fff;padding:12px;border:1px solid #999'></div>";		// Scrollable container
		$("#mdAssets").html(str);												// Add results to panel
